...
cmake -DVTK_OPENGL_HAS_OSMESA=ON \
      ...
      -Dcatalyst_DIR=`pwd`/catalyst-v2.0.0-rc4-install \
      -S ParaView-v5.11.2 \
...
echo "export PYTHONPATH=$PYTHONPATH:`pwd`/catalyst-v2.0.0-rc4-install/lib/python3.9/site-packages/" >> catalyst_docker_setup_env.sh
